...
QT_MOC_LITERAL(1, 11, 15), // "pressedLineEdit"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 10), // "QLineEdit*"
QT_MOC_LITERAL(4, 39, 6) // "widget"

    },
    "MyLineEdit\0pressedLineEdit\0\0QLineEdit*\0"
    "widget"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pressedLineEdit((*reinterpret_cast< QLineEdit*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (MyLineEdit::*)(QLineEdit * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLineEdit::pressedLineEdit)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLineEdit::pressedLineEdit(QLineEdit * _t1)
{
