#ifndef MYTHREESTATESLABELANIMATED_H
#define MYTHREESTATESLABELANIMATED_H
...
class MyThreeStatesLabelAnimated : public QLabel
{
    Q_OBJECT
public:
    explicit MyThreeStatesLabelAnimated(QWidget *parent = nullptr);
     ~MyThreeStatesLabelAnimated();
...
#endif // MYTHREESTATESLABELANIMATED_H
